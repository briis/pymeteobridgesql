...
foreach($forecastdata["days"] as $value) {
    ...
    $jobj_fcst->conditions = $value["conditions"];
    ...
    foreach($value["hours"] as $hour) {
        ...
        $jobj_hour->visibility = $hour["visibility"];
